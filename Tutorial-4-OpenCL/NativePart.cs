...
public static class NativePart
{
    ...
    [DllImport("libJNIpart", EntryPoint = "Java_org_opencv_samples_opencl_NativePart_builtWithOpenCL")]
    public extern static bool BuiltWithOpenCL(IntPtr env, IntPtr jniClass);
